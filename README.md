...
The study also considers aspects of Human-Computer Interaction (HCI) principles to ensure the Information Kiosk’s design aligns with user expectations and promotes a positive user experience. By incorporating HCI principles, the project aims to minimize user errors, enhance information accessibility, and foster user satisfaction.
